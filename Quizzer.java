...
public class Quizzer{ 
    ...
    public void runQuiz(){
        ...
        if(quizType.equals("history")){
            ...
            if(firstQuestion.QuestionAndAnswerHis().equals("Correct"))score++;
            questionNum++;
            for(int i=0;i<9;i++){
            ...
            if(firstQuestion.QuestionAndAnswerMath().equals("Correct"))score++;
            questionNum++;
            for(int i=0;i<9;i++){
                Averages thisAverage=new Averages(questionNum,score);
                thisAverage.currentAvg();
